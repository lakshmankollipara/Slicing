...
public final class expenses_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (!loggedUser.equals("none")) {
      ...
      out.write("        ");
            ...
            try {
                ...
                if (found) {
                    ...
                    out.println("<caption>Generalization</caption>");
                    out.println("<tr><th>Employee Designation</th><th>Employee Salary</th><th>Email</th><th>Zip</th><th>Gender</th></tr>");
                    
                    double sum = 0.0;
                    for(int i=0;i<ename.length;i++)
                    {
                        out.println("<tr><td>" + about[i] + "</td><td>" + (Double.parseDouble(salary[i])<=half?range1:range2) + "</td><td>" + Resource.sliceMail(email[i]) + "</td><td>" + Resource.sliceZip(zip[i]) + "</td><td>" + Resource.sliceString(sex[i]) + "</td></tr>");
      ...
      out.write("\n");
      out.write("        <a href=\"admin.jsp\"> ADMIN MENU </a>\n");
      out.write("    </center>\n");
      out.write("\n");
      out.write("\n");
      out.write("    ");
